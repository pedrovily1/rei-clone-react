          ...
          <ul className="accordion-group">
            ...
            <li id="product-questions-accordion">
              ...
              <div className="questions-container">
                ...
                <div id="question">
                  <div className="question-text">Q: is this TSA approved? most bags will say if so</div>
                ...
                <div id="answer-container">
                  <div className="answer-section">
                    ...
                    <span className="answer-text">This pack is 18.7 x 12.6 x 9.8 inches.Most airlines require a piece of
                      carry-on luggage to be no bigger than 45 linear inches (L + W + H) to meet carry-on size
                      restrictions. This can vary so please check with your airline ahead of time.</span>
                  </div>
                  ...
                  <div className="interaction-section">
                    <div className="end-of-page">
                      <div className="helpful">
                        Helpful?
                        <img src={Thumbsupout} alt="Logo" id="Thumbsupout"></img>

                        (0)
                        <img src={Thumbsdownout} alt="Logo" id="Thumbsdownout"></img>
                ...
                <hr className="black-line"></hr>
                  ...
                  <div id="question">
                    <div className="question-text">Q: Can this item be returned after the 1 year mark? Zippers open on the main
                      compartment whenever my dog leans on it and she falls out
                  ...
                  <div id="answer-container">
                    <div className="answer-section">
                      <span className="answer-label">A:</span>
                      <span className="answer-text">You can learn more about our return policy here:
                  ...
                  <div id="question">
                    <div className="question-text">Q: Would anyone know if this is airline travel approved as well?
                  ...
                  <div id="answer-container">
                    <div className="answer-section">
                      <span className="answer-label">A:</span>
                      <span className="answer-text">Please consult your airline of choice to learn if this pack is approved for travel on their planes.
